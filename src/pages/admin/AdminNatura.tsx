          ...
          <div className="flex items-center justify-between bg-card p-3 rounded-xl border border-border shadow-sm">
            ...
            <div className="flex items-center gap-2">
              ...
              <select
                ...
                className="h-9 px-3 rounded-lg bg-secondary border-border text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-emerald-500/30 appearance-none cursor-pointer border"
              >
